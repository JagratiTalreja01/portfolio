...
export const momentsSequence: MomentMedia[] = [
  { src: 'media/moments/01-conference-podium.jpeg', type: 'image', alt: 'Presenting remote-sensing research at a conference podium.', layout: 'half' },
  { src: 'media/moments/02-igarss-presentation.jpeg', type: 'image', alt: 'Presenting cross-polarization fusion research at IGARSS.', layout: 'half' },
  { src: 'media/moments/03-ieee-conference-group.jpeg', type: 'image', alt: 'Group photograph with colleagues at an IEEE conference.', layout: 'wide' },
  { src: 'media/moments/04-community-reel-hq.mp4', poster: 'media/moments/04-community-reel-hq-poster.webp', type: 'video', alt: 'Travel highlights video.', layout: 'portrait' },
  { src: 'media/moments/05-ncat-lab-team.jpeg', type: 'image', alt: 'Research team in the laboratory at North Carolina A&T.', layout: 'half' },
  { src: 'media/moments/06-ncat-lab-community.jpeg', type: 'image', alt: 'Students and researchers gathering in the laboratory.', layout: 'half' },
  { src: 'media/moments/07-recognition.jpeg', type: 'image', alt: 'Receiving recognition with academic colleagues.', layout: 'third' },
  { src: 'media/moments/08-gis-day.jpeg', type: 'image', alt: 'Representing North Carolina A&T at GIS Day.', layout: 'third' },
  { src: 'media/moments/09-ieee-community.jpeg', type: 'image', alt: 'With colleagues at an IEEE event.', layout: 'third' },
  { src: 'media/moments/10-research-group.jpeg', type: 'image', alt: 'Research group photograph in the laboratory.', layout: 'half' },
  { src: 'media/moments/11-community-outdoors.jpeg', type: 'image', alt: 'Community gathering outdoors on campus.', layout: 'half' },
  { src: 'media/moments/12-bowling-indoor.jpeg', type: 'image', alt: 'Bowling with friends and colleagues.', layout: 'third' },
  { src: 'media/moments/13-bowling-outdoor.jpeg', type: 'image', alt: 'Friends and colleagues outside the bowling venue.', layout: 'third' },
  { src: 'media/moments/14-professional-group.jpeg', type: 'image', alt: 'Professional group photograph at an event.', layout: 'third' },
  { src: 'media/moments/15-poster-team.jpg', type: 'image', alt: 'Research team presenting the Medi-Cart project poster.', layout: 'half' },
  { src: 'media/moments/16-travel-community.jpg', type: 'image', alt: 'Travel photograph with an international student group.', layout: 'half' },
  { src: 'media/moments/17-phd-highlights-hq.mp4', poster: 'media/moments/17-phd-highlights-hq-poster.webp', type: 'video', alt: 'Outdoor aircraft project highlights video.', layout: 'wide' },
  { src: 'media/moments/18-phd-collage.jpeg', type: 'image', alt: 'Collage celebrating completion of the PhD.', layout: 'narrow' },
  { src: 'media/moments/19-ieee-better-world.jpg', type: 'image', alt: 'IEEE Better World event group photograph.', layout: 'half' },
  { src: 'media/moments/20-classroom-team.jpg', type: 'image', alt: 'Classroom and research team group photograph.', layout: 'half' },
  { src: 'media/moments/21-community-montage-hq.mp4', poster: 'media/moments/21-community-montage-hq-poster.webp', type: 'video', alt: 'Color-tracking research demonstration video.', layout: 'full' },
  { src: 'media/moments/22-student-team.JPG', type: 'image', alt: 'Student aircraft team gathered outdoors.', layout: 'half' },
